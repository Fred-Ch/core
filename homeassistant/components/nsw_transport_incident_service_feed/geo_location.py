...
ATTR_FEATURE_TYPE = "Feature_Type"
ATTR_ROAD = "Road"
...
VALID_HAZARDS = ["Alpine", "Fire", "Flood", "Incident", "Major events", "Roadworks"]
VALID_HAZARDS_STATE = ["Open","Closed",""]
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional(CONF_HAZARDS, default=DEFAULT_HAZARDS):  vol.Coerce(str),
        vol.Optional(CONF_HAZARDS_STATE, default=DEFAULT_HAZARDS_STATE): vol.Coerce(str),
...
async def async_setup_platform(
    ...
    manager = NswTransportServiceFeedEntityManager(
        hass, async_add_entities, scan_interval, coordinates, radius_in_km, categories, hazard
    )
